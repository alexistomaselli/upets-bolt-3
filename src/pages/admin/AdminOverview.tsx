...
export const AdminOverview: React.FC = () => {
    const { isSuperAdmin, isCompanyAdmin, isBranchAdmin } = useAuth();
    ...
    const quickActions = [
        { name: 'Gestionar Usuarios', icon: Users, action: '/admin/usuarios', color: 'bg-blue-600' },
        { name: 'Comercios', icon: Store, action: '/admin/comercios', color: 'bg-green-600' },
        { name: 'Gestión QR', icon: QrCode, action: '/admin/qr', color: 'bg-purple-600' },
        { name: 'Configurar Roles', icon: Shield, action: '/admin/roles', color: 'bg-orange-600' },
        { name: 'Configuración', icon: Settings, action: '/admin/configuracion', color: 'bg-gray-600' },
    ];
